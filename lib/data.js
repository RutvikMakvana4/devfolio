...
export const personalProjects = [
  {
    name: "Mini AI Builder",
    description:
      "Turn natural-language prompts into live, deployed Next.js + Tailwind apps — powered by free-tier LLMs, sandboxed builds with automatic self-repair, and real-time streaming updates.",
    websiteLink: "https://mini-ai-builder-web.vercel.app/",
    image: "/projects/mini-ai-builder.png",
    repoLink: "https://github.com/RutvikMakvana4/mini-ai-builder",
  },
  {
    name: "AI Agent Kit",
    description:
    ...
    repoLink: "https://github.com/RutvikMakvana4/agentkit-frontend",
  },
  {
    ...
    repoLink: "https://github.com/RutvikMakvana4/ResultManagementSystem",
  },
];
...
export const packageProjects = [
  {
    ...
    description:
      "A powerful CLI that scaffolds production-ready Express.js and NestJS backend projects with TypeScript, preconfigured folder structures, and essential development tooling in seconds.",
    websiteLink:
      "https://www.npmjs.com/package/@rutvikmakvana/backend-launcher",
  },
  {
    name: "agentkit-node SDK",
    description:
      "An official Node.js SDK for integrating AgentKit into backend applications, enabling AI agents to securely discover, register, and execute your existing APIs as intelligent tools with minimal configuration.",
    websiteLink: "https://www.npmjs.com/package/@rutvikmakvana/agentkit-node",
  },
];
